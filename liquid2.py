...
for trial in range(ntrials):
    ...
    if hasPump:
        ...
        print 'no pump: should be injecting via pump at address %d'%pump[trial]+str(trialdata['onset'])
    ...
    if hasPump:
        ...
        print 'no pump: should be injecting rinse via pump at address %d'%pump[trial]+str(trialdata['onset']+cue_time+delivery_time+wait_time)
